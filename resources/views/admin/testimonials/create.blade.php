...
@section('content')
    <div style="padding: 2rem; max-width: 800px; margin: 0 auto;">
        <div style="margin-bottom: 2rem;">
            ...
            <h1 style="font-size: 2rem; font-weight: 700; color: #1f2937;">Add New Testimonial</h1>
        </div>
        ...
        <div style="background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); padding: 2rem;">
            <form action="{{ route('admin.testimonials.store') }}" method="POST">
                ...
                <div style="margin-bottom: 1.5rem;">
                    ...
                    <textarea name="message" rows="5" required placeholder="Write the client's testimonial here..."
