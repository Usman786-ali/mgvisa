    ...
    <div style="padding: 2rem;">
        <div style="margin-bottom: 2rem;">
            <a href="{{ route('admin.packages.index') }}"
                style="color: #3b82f6; text-decoration: none; display: inline-flex; align-items: center; gap: 0.5rem; margin-bottom: 1rem;">
                <i class="fas fa-arrow-left"></i> Back to Packages
            </a>
            <h1 style="font-size: 2rem; font-weight: 700; color: #1f2937;">Create New Package</h1>
            <p style="color: #6b7280; margin-top: 0.5rem;">Add a new package for Standard or Ramadan offerings</p>
        </div>

        @if($errors->any())
            <div
                style="background: #fee2e2; border: 1px solid #fca5a5; color: #991b1b; padding: 1rem; border-radius: 8px; margin-bottom: 1.5rem;">
        ...
        <form action="{{ route('admin.packages.store') }}" method="POST">
            ...
            <div
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem;">
                    <div>
                        <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Package
                            Name</label>
                    ...
                    <div>
                        <label
                            style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Category</label>
                        <select name="category" required
                            style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem;">
                            <option value="standard" {{ old('category') == 'standard' ? 'selected' : '' }}>Standard Umrah
                            </option>
                            <option value="ramadan" {{ old('category') == 'ramadan' ? 'selected' : '' }}>Ramadan Special
                            </option>
                        </select>
                    </div>

                    <div>
                        <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Tier /
                            Type</label>
                    ...
                    <div>
                        <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Price
                            (USD/PKR)</label>
                    ...
                    <div>
                        <label
                            style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Duration</label>
                    ...
                    <div>
                        <label style="display: block; margin-bottom: 0.5rem; font-weight: 600; color: #374151;">Icon
                            Class</label>
                        <input type="text" name="icon" value="{{ old('icon', 'fas fa-kaaba') }}" required
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-top: 1.5rem;">
                    <div>
                        <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                            ...
                            <span style="font-weight: 600; color: #374151;">Mark as "Best Value" / Popular</span>
                        </label>
                    </div>
            ...
            <div
                ...
                <div id="features-container">
                    <div class="feature-row"
                        style="display: grid; grid-template-columns: 1fr auto auto; gap: 1rem; margin-bottom: 1rem; padding: 1rem; background: #f9fafb; border-radius: 8px;">
                        <div>
                        ...
                        <div style="display: flex; align-items: center; gap: 0.5rem;">
                            <label
                                style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer; white-space: nowrap;">
                                <input type="checkbox" name="feature_included[0]" value="1" checked
                                    style="width: 20px; height: 20px; cursor: pointer;">
            ...
            <div
                ...
                <button type="submit"
                    style="background: linear-gradient(135deg, #10b981 0%, #059669 100%); color: white; padding: 1rem 2rem; border-radius: 8px; border: none; cursor: pointer; font-weight: 600; font-size: 1rem; box-shadow: 0 4px 12px rgba(16, 185, 129, 0.3);">
