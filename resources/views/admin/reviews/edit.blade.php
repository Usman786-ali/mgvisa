...
<div style="padding: 2rem; max-width: 800px; margin: 0 auto;">
    <div style="margin-bottom: 2rem;">
        ...
        <h1 style="font-size: 2rem; font-weight: 700; color: #1f2937;">Edit review</h1>
    </div>
    ...
    <div style="background: white; border-radius: 12px; box-shadow: 0 4px 20px rgba(0,0,0,0.08); padding: 2rem;">
        <form action="{{ route('admin.reviews.update', $review) }}" method="POST">
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <input type="text" name="client_name" value="{{ old('client_name', $review->client_name) }}" required
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 1.5rem; margin-bottom: 1.5rem;">
                <div>
                    ...
                    <input type="text" name="position" value="{{ old('position', $review->position) }}"
                ...
                <div>
                    ...
                    <input type="text" name="company" value="{{ old('company', $review->company) }}"
            ...
            <div style="margin-bottom: 1.5rem;">
                ...
                <textarea name="message" rows="5" required
                          ...
                          style="width: 100%; padding: 0.75rem; border: 1px solid #d1d5db; border-radius: 8px; font-size: 1rem; font-family: inherit;">{{ old('message', $review->message) }}</textarea>
                @error('message')
                    <p style="color: #ef4444; font-size: 0.875rem; margin-top: 0.25rem;">{{ $message }}</p>
                @enderror
            </div>
