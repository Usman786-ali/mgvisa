        ...
        <div class="card-body" style="padding: 30px;">
            <form action="{{ route('admin.countries.store') }}" method="POST">
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    ...
                    <div>
                        <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;">Processing
                            Time</label>
                        <input type="text" name="processing_time" placeholder="e.g., 2-4 weeks"
                            style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea name="requirements" rows="3" placeholder="List visa requirements..."
                        style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;"></textarea>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;">Visa Fees
                            ($)</label>
                        <input type="number" name="fees" step="0.01" placeholder="0.00"
                            style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                    </div>
                    <div>
