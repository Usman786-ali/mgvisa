...
<head>
    ...
    <meta name="description"
        content="@yield('meta_description', 'Professional visa consultation services for all your travel needs')">
    <meta name="keywords" content="@yield('meta_keywords', 'visa consultant, visa services, immigration, travel visa')">
    <title>@yield('title', 'MG Visa Consultant - Your Gateway to the World')</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/custom_countries.css') }}">
        ...
        <div class="container">
            <div class="nav-wrapper">
                <a href="{{ url('/') }}" class="logo">
                    <img src="{{ asset('images/logo.png') }}" alt="MG Visa Consultancy" class="logo-image">
                </a>
                ...
                <div class="nav-menu" id="navMenu">
                    ...
                    <a href="{{ url('/countries') }}"
                        class="nav-link {{ request()->is('countries') ? 'active' : '' }}">Countries</a>
                    <a href="{{ url('/blogs') }}"
                        class="nav-link {{ request()->is('blogs') ? 'active' : '' }}">Blogs</a>
                    <a href="{{ url('/contact') }}"
                ...
                <div class="footer-grid">
                    ...
                    <div class="footer-col">
                        ...
                        <div class="social-links">
                            @if($socialSettings['social_facebook'] ?? false)
                                <a href="{{ $socialSettings['social_facebook'] }}" class="social-link" target="_blank"><i
                                        class="fab fa-facebook-f"></i></a>
                            @endif
                            @if($socialSettings['social_instagram'] ?? false)
                                <a href="{{ $socialSettings['social_instagram'] }}" class="social-link" target="_blank"><i
                                        class="fab fa-instagram"></i></a>
                            @endif
                            @if($socialSettings['social_youtube'] ?? false)
                                <a href="{{ $socialSettings['social_youtube'] }}" class="social-link" target="_blank"><i
                                        class="fab fa-youtube"></i></a>
                            @endif
                            @if($socialSettings['social_tiktok'] ?? false)
                                <a href="{{ $socialSettings['social_tiktok'] }}" class="social-link" target="_blank"><i
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-bottom-content">
                    <p>&copy; {{ date('Y') }} MG Visa Consultant. All rights reserved.</p>
