...
@section('title', 'MG Visa Consultant - Your Gateway to the World')
...
@section('content')
    ...
    <section class="hero" id="home">
        ...
        @if($heroMediaType == 'slideshow' && $heroMedia)
            @php
            ...
            <div class="hero-slideshow">
                @foreach($slideshowImages as $index => $image)
                    <div class="slide {{ $index == 0 ? 'active' : '' }}" style="background-image: url('{{ asset($image) }}')"></div>
                @endforeach
            </div>
        @elseif($heroMediaType == 'video' && $heroMedia)
            <!-- Video Mode -->
            <div class="hero-video-wrapper">
                <video autoplay muted loop playsinline class="hero-video">
                    <source src="{{ asset($heroMedia) }}" type="video/mp4">
                </video>
            </div>
        @else
            ...
            <div class="hero-slideshow">
                <div class="slide active"
                    style="background-image: url('{{ $heroMedia ? asset($heroMedia) : asset('images/hero-bg-1.jpg') }}')"></div>
            </div>
        @endif
        ...
        <div class="container">
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <p class="hero-subtitle">{{ $generalSettings['site_name'] ?? 'MG Visa Consultancy' }}</p>
                    <p class="hero-description">
                        {{ $generalSettings['site_description'] ?? 'Expert visa consultation services to make your travel dreams a reality.' }}
                    </p>
                    <div class="hero-buttons">
                        ...
                        @endphp
                        <a href="{{ $button1Link }}" class="btn btn-primary" target="_blank">
                            <i class="fab fa-whatsapp"></i>
                            <span>{{ $button1Text }}</span>
                        </a>
                        <a href="{{ $button2Link }}" class="btn btn-outline">
                ...
                <div class="hero-image">
                    ...
                    <div class="hero-stats">
                        <div class="stat">
                            <div class="stat-number">{{ $statsSettings['stats_clients'] ?? '0' }}+</div>
                            <div class="stat-label">Happy Clients</div>
                        </div>
                        <div class="stat">
                            <div class="stat-number">{{ $statsSettings['stats_countries'] ?? '0' }}+</div>
                            <div class="stat-label">Countries</div>
                        </div>
                        <div class="stat">
                            <div class="stat-number">{{ $statsSettings['stats_success_rate'] ?? '0' }}%</div>
        ...
        <div class="container">
            ...
            <div class="packages-grid">
                @foreach($packages as $package)
                    <div class="package-card {{ $package->type }}-package">
                        @if($package->is_popular)
                            <div class="package-badge">Best Value</div>
                        @endif
                        <div class="package-header">
                            <div class="package-icon"><i class="{{ $package->icon }}"></i></div>
                            <h3 class="package-name">{{ $package->name }}</h3>
                            <div class="package-price">PKR {{ number_format($package->price, 0) }} <span>/ person</span></div>
                            <div class="package-duration">{{ $package->duration }}</div>
                        </div>
                        <ul class="package-features">
                            @foreach($package->features as $feature)
                                <li style="{{ !$feature['included'] ? 'opacity: 0.5;' : '' }}">
                                    <i class="fas {{ $feature['included'] ? 'fa-check' : 'fa-times' }}"></i>
                                    {{ $feature['text'] }}
                                </li>
                            @endforeach
                        </ul>
                        <a href="{{ url('/contact') }}" class="package-btn btn-{{ $package->type }}">Choose Plan</a>
                    </div>
                @endforeach
            </div>
        </div>
                    ...
                    <div class="country-card-simple">
                        <div class="country-flag-wrapper">
                            <div class="country-flag">
                                ...
                                @if($flagCode)
                                    <img src="https://flagcdn.com/w160/{{ $flagCode }}.png" alt="{{ $country->name }}"
                        ...
                        <h3 class="country-name-simple">{{ strtoupper($country->name) }}</h3>
                    </div>
                @endforeach
            </div>
        </div>
                ...
                <div class="why-choose-image">
                    <div class="image-card"
                        ...
                        <a href="https://wa.me/923002194957" target="_blank" style="display: block; text-decoration: none;">
                            <img src="{{ asset('images/wisdom-logo.jpg') }}" alt="Wisdom Global Studies - Click to WhatsApp"
                    ...
                    <div class="team-card">
                        ...
                        <div class="team-content">
                            ...
                            <div class="team-social">
                                ...
                                @endphp
                                <a href="https://wa.me/{{ $whatsapp }}" target="_blank" class="team-whatsapp-btn">
                                    <i class="fab fa-whatsapp"></i>
                                    <span>WhatsApp</span>
                                </a>
                            </div>
                    ...
                    <div class="testimonial-card">
                        ...
                        <div class="testimonial-author">
                            ...
                            <div class="author-info">
                                ...
                                <p>{{ $testimonial->position }}{{ $testimonial->company ? ', ' . $testimonial->company : '' }}
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="contact-form-wrapper">
                    @if(session('success'))
                        <div class="alert alert-success"
                            ...
                            <strong style="font-size: 1.1rem; vertical-align: middle;">{{ session('success') }}</strong>
                        </div>
                    @endif
                    <form action="{{ url('/inquiry') }}" method="POST" class="contact-form">
                        @csrf
                        <div class="form-row">
                            <div class="form-group">
