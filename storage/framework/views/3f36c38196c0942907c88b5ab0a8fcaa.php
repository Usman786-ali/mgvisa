...
<?php $__env->startSection('header', 'Edit Service'); ?>
        ...
        <div class="card-body" style="padding: 30px;">
            <form action="<?php echo e(route('admin.services.update', $service->id)); ?>" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <input type="text" name="title" value="<?php echo e($service->title); ?>" required
                ...
                <div style="margin-bottom: 20px;">
                    <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;">Short
                        Description</label>
                    <input type="text" name="short_description" value="<?php echo e($service->short_description); ?>" required
                        style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                </div>
                ...
                <div style="margin-bottom: 20px;">
                    ...
                    <textarea name="description" required rows="5"
                        style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;"><?php echo e($service->description); ?></textarea>
                </div>
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin-bottom: 20px;">
                    <div>
                        <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;">Icon Class
                            (FontAwesome)</label>
                        <input type="text" name="icon" value="<?php echo e($service->icon); ?>" required
                            style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                    </div>
                    <div>
                        <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;">Display
                            Order</label>
                        <input type="number" name="order" value="<?php echo e($service->order); ?>"
                            style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\mgvisa\resources\views/admin/services/edit.blade.php ENDPATH**/ ?>