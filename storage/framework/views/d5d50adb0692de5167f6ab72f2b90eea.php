...
<?php $__env->startSection('content'); ?>
    ...
    <div class="stats-grid">
        <div class="stat-card-modern blue">
            ...
            <div class="stat-value-modern"><?php echo e($stats['inquiries']); ?></div>
        ...
        <div class="stat-card-modern green">
            ...
            <div class="stat-value-modern"><?php echo e($stats['services']); ?></div>
        ...
        <div class="stat-card-modern purple">
            ...
            <div class="stat-value-modern"><?php echo e($stats['countries']); ?></div>
        ...
        <div class="stat-card-modern gold">
            ...
            <div class="stat-value-modern"><?php echo e($stats['pending_reviews']); ?></div>
    ...
    <div class="quick-actions">
        ...
        <div class="quick-actions-grid">
            ...
            <a href="<?php echo e(route('admin.countries.create')); ?>" class="action-btn">
                <i class="fas fa-flag"></i>
                <span>Add Country</span>
            </a>
            <a href="<?php echo e(route('admin.team.index')); ?>" class="action-btn">
                <i class="fas fa-users"></i>
                <span>Manage Team</span>
            </a>
            <a href="<?php echo e(route('admin.packages.index')); ?>" class="action-btn">
                <i class="fas fa-box"></i>
                <span>Edit Packages</span>
            </a>
            <a href="<?php echo e(route('admin.settings.homepage')); ?>" class="action-btn">
                <i class="fas fa-paint-brush"></i>
                <span>Homepage Settings</span>
            </a>
            <a href="<?php echo e(route('admin.reviews.index')); ?>" class="action-btn">
    ...
    <div class="recent-section">
        ...
        <table class="modern-table">
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $latestInquiries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inquiry): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        <td>
                            <strong><?php echo e($inquiry->created_at->format('M d')); ?></strong>
                            <br>
                            <small style="color: #9ca3af;"><?php echo e($inquiry->created_at->format('Y')); ?></small>
                        </td>
                        <td>
                        ...
                        <td><span class="badge badge-info"><?php echo e($inquiry->visa_type ?? 'General'); ?></span></td>
                        <td><span class="badge badge-warning"><?php echo e($inquiry->country_of_interest ?? 'N/A'); ?></span></td>
        ...
        <?php if($latestInquiries->count() > 0): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\mgvisa\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>