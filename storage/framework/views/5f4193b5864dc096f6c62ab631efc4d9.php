...
<?php $__env->startSection('header', 'Site Settings'); ?>
                    ...
                    <form action="<?php echo e(route('admin.settings.update')); ?>" method="POST">
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="site_name"
                                value="<?php echo e($settings['general']->where('key', 'site_name')->first()->value ?? ''); ?>"
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <input type="text" name="site_tagline"
                                value="<?php echo e($settings['general']->where('key', 'site_tagline')->first()->value ?? ''); ?>"
                                style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                        </div>
                        ...
                        <div style="margin-bottom: 20px;">
                            ...
                            <textarea name="site_description" rows="4"
                                style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;"><?php echo e($settings['general']->where('key', 'site_description')->first()->value ?? ''); ?></textarea>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                ...
                                <input type="email" name="contact_email"
                                    value="<?php echo e($settings['contact']->where('key', 'contact_email')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div>
                                ...
                                <input type="text" name="contact_phone"
                                    value="<?php echo e($settings['contact']->where('key', 'contact_phone')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div>
                                ...
                                <input type="text" name="contact_whatsapp"
                                    value="<?php echo e($settings['contact']->where('key', 'contact_whatsapp')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div style="grid-column: span 2;">
                                ...
                                <textarea name="contact_address" rows="2"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;"><?php echo e($settings['contact']->where('key', 'contact_address')->first()->value ?? ''); ?></textarea>
                            </div>
                        </div>
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                            <div>
                                ...
                                <input type="text" name="social_facebook"
                                    value="<?php echo e($settings['social']->where('key', 'social_facebook')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div>
                                <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;"><i
                                ...
                                <input type="text" name="social_instagram"
                                    value="<?php echo e($settings['social']->where('key', 'social_instagram')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div>
                                <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;"><i
                                ...
                                <input type="text" name="social_youtube"
                                    value="<?php echo e($settings['social']->where('key', 'social_youtube')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                            <div>
                                <label style="display:block; margin-bottom:5px; font-weight:500; color:#4b5563;"><i
                                ...
                                <input type="text" name="social_tiktok"
                                    value="<?php echo e($settings['social']->where('key', 'social_tiktok')->first()->value ?? ''); ?>"
                                    style="width:100%; padding:10px; border:1px solid #d1d5db; border-radius:4px;">
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\mgvisa\resources\views/admin/settings/index.blade.php ENDPATH**/ ?>